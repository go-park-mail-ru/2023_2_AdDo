...
func easyjson3e1fa5ecDecodeMainInternalPkgUser3(in *jlexer.Lexer, out *ForgotPasswordInput) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3e1fa5ecEncodeMainInternalPkgUser3(out *jwriter.Writer, in ForgotPasswordInput) {
	out.RawByte('{')
	first := true
	_ = first
	{
