...
const (
	...
	AlbumService_GetAlbumByTrack_FullMethodName = "/AlbumService/GetAlbumByTrack"
...
type AlbumServiceClient interface {
	GetRandom(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AlbumsResponse, error)
	GetMostLiked(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AlbumsResponse, error)
	GetPopular(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AlbumsResponse, error)
	GetNew(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AlbumsResponse, error)
	...
	Like(ctx context.Context, in *AlbumToUserId, opts ...grpc.CallOption) (*emptypb.Empty, error)
	IsLike(ctx context.Context, in *AlbumToUserId, opts ...grpc.CallOption) (*IsLikedAlbum, error)
	Unlike(ctx context.Context, in *AlbumToUserId, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *albumServiceClient) GetRandom(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AlbumsResponse, error) {
...
func (c *albumServiceClient) GetMostLiked(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AlbumsResponse, error) {
	out := new(AlbumsResponse)
...
func (c *albumServiceClient) GetPopular(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AlbumsResponse, error) {
	out := new(AlbumsResponse)
...
func (c *albumServiceClient) GetNew(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AlbumsResponse, error) {
	out := new(AlbumsResponse)
...
func (c *albumServiceClient) GetAlbumByTrack(ctx context.Context, in *proto.TrackId, opts ...grpc.CallOption) (*AlbumResponse, error) {
	out := new(AlbumResponse)
	err := c.cc.Invoke(ctx, AlbumService_GetAlbumByTrack_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *albumServiceClient) Like(ctx context.Context, in *AlbumToUserId, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *albumServiceClient) Unlike(ctx context.Context, in *AlbumToUserId, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type AlbumServiceServer interface {
	GetRandom(context.Context, *emptypb.Empty) (*AlbumsResponse, error)
	GetMostLiked(context.Context, *emptypb.Empty) (*AlbumsResponse, error)
	GetPopular(context.Context, *emptypb.Empty) (*AlbumsResponse, error)
	GetNew(context.Context, *emptypb.Empty) (*AlbumsResponse, error)
	GetAlbum(context.Context, *AlbumId) (*AlbumResponse, error)
	GetAlbumByTrack(context.Context, *proto.TrackId) (*AlbumResponse, error)
	Like(context.Context, *AlbumToUserId) (*emptypb.Empty, error)
	IsLike(context.Context, *AlbumToUserId) (*IsLikedAlbum, error)
	Unlike(context.Context, *AlbumToUserId) (*emptypb.Empty, error)
...
func (UnimplementedAlbumServiceServer) GetRandom(context.Context, *emptypb.Empty) (*AlbumsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetRandom not implemented")
}
func (UnimplementedAlbumServiceServer) GetMostLiked(context.Context, *emptypb.Empty) (*AlbumsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMostLiked not implemented")
}
func (UnimplementedAlbumServiceServer) GetPopular(context.Context, *emptypb.Empty) (*AlbumsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPopular not implemented")
}
func (UnimplementedAlbumServiceServer) GetNew(context.Context, *emptypb.Empty) (*AlbumsResponse, error) {
...
func (UnimplementedAlbumServiceServer) Like(context.Context, *AlbumToUserId) (*emptypb.Empty, error) {
...
func (UnimplementedAlbumServiceServer) Unlike(context.Context, *AlbumToUserId) (*emptypb.Empty, error) {
...
func _AlbumService_GetRandom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AlbumServiceServer).GetRandom(ctx, req.(*emptypb.Empty))
	}
...
func _AlbumService_GetMostLiked_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AlbumServiceServer).GetMostLiked(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AlbumService_GetPopular_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AlbumServiceServer).GetPopular(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AlbumService_GetNew_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AlbumServiceServer).GetNew(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AlbumService_GetAlbumByTrack_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AlbumService_GetAlbumByTrack_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
