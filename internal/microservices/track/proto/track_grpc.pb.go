...
type TrackServiceClient interface {
	Listen(ctx context.Context, in *TrackToUserDur, opts ...grpc.CallOption) (*emptypb.Empty, error)
	Skip(ctx context.Context, in *TrackToUserDur, opts ...grpc.CallOption) (*emptypb.Empty, error)
	Like(ctx context.Context, in *TrackToUserId, opts ...grpc.CallOption) (*emptypb.Empty, error)
	IsLike(ctx context.Context, in *TrackToUserId, opts ...grpc.CallOption) (*IsLikedTrack, error)
	Unlike(ctx context.Context, in *TrackToUserId, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *trackServiceClient) Listen(ctx context.Context, in *TrackToUserDur, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *trackServiceClient) Skip(ctx context.Context, in *TrackToUserDur, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (c *trackServiceClient) Like(ctx context.Context, in *TrackToUserId, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (c *trackServiceClient) Unlike(ctx context.Context, in *TrackToUserId, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type TrackServiceServer interface {
	Listen(context.Context, *TrackToUserDur) (*emptypb.Empty, error)
	Skip(context.Context, *TrackToUserDur) (*emptypb.Empty, error)
	Like(context.Context, *TrackToUserId) (*emptypb.Empty, error)
	IsLike(context.Context, *TrackToUserId) (*IsLikedTrack, error)
	Unlike(context.Context, *TrackToUserId) (*emptypb.Empty, error)
...
func (UnimplementedTrackServiceServer) Listen(context.Context, *TrackToUserDur) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Listen not implemented")
}
func (UnimplementedTrackServiceServer) Skip(context.Context, *TrackToUserDur) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Skip not implemented")
}
func (UnimplementedTrackServiceServer) Like(context.Context, *TrackToUserId) (*emptypb.Empty, error) {
...
func (UnimplementedTrackServiceServer) Unlike(context.Context, *TrackToUserId) (*emptypb.Empty, error) {
