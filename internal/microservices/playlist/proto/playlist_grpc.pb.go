...
type PlaylistServiceClient interface {
	...
	IsCreator(ctx context.Context, in *PlaylistToUserId, opts ...grpc.CallOption) (*IsPlaylistCreator, error)
...
func (c *playlistServiceClient) IsCreator(ctx context.Context, in *PlaylistToUserId, opts ...grpc.CallOption) (*IsPlaylistCreator, error) {
	out := new(IsPlaylistCreator)
	err := c.cc.Invoke(ctx, "/PlaylistService/IsCreator", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *playlistServiceClient) PlaylistCollections(ctx context.Context, in *proto.UserId, opts ...grpc.CallOption) (*PlaylistsBase, error) {
	out := new(PlaylistsBase)
	err := c.cc.Invoke(ctx, "/PlaylistService/PlaylistCollections", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *playlistServiceClient) HasReadAccess(ctx context.Context, in *PlaylistId, opts ...grpc.CallOption) (*HasAccess, error) {
	out := new(HasAccess)
	err := c.cc.Invoke(ctx, "/PlaylistService/HasReadAccess", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *playlistServiceClient) MakePrivate(ctx context.Context, in *PlaylistId, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/PlaylistService/MakePrivate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *playlistServiceClient) MakePublic(ctx context.Context, in *PlaylistId, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/PlaylistService/MakePublic", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *playlistServiceClient) UpdateName(ctx context.Context, in *PlaylistIdToNewTitle, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/PlaylistService/UpdateName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PlaylistServiceServer interface {
	...
	IsCreator(context.Context, *PlaylistToUserId) (*IsPlaylistCreator, error)
...
func (UnimplementedPlaylistServiceServer) IsCreator(context.Context, *PlaylistToUserId) (*IsPlaylistCreator, error) {
...
func _PlaylistService_IsCreator_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PlaylistToUserId)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PlaylistServiceServer).IsCreator(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/PlaylistService/IsCreator",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlaylistServiceServer).IsCreator(ctx, req.(*PlaylistToUserId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PlaylistService_PlaylistCollections_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/PlaylistService/PlaylistCollections",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PlaylistService_HasModifyAccess_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/PlaylistService/HasModifyAccess",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PlaylistService_HasReadAccess_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/PlaylistService/HasReadAccess",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PlaylistService_MakePrivate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/PlaylistService/MakePrivate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PlaylistService_MakePublic_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/PlaylistService/MakePublic",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PlaylistService_UpdateName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/PlaylistService/UpdateName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var PlaylistService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PlaylistService_IsCreator_Handler,
		},
		{
