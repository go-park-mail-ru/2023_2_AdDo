...
func (m *MockUseCase) Create(playlist playlist.Base) (playlist.Response, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUseCaseMockRecorder) Create(playlist interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockUseCase)(nil).Create), playlist)
}
...
func (m *MockUseCase) Get(userId string, playlistId uint64) (playlist.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", userId, playlistId)
	ret0, _ := ret[0].(playlist.Response)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUseCaseMockRecorder) Get(userId, playlistId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockUseCase)(nil).Get), userId, playlistId)
}
...
// Create mocks base method.
func (m *MockRepository) Create(ctx context.Context, playlist playlist.Base) (playlist.Response, error) {
	m.ctrl.T.Helper()
