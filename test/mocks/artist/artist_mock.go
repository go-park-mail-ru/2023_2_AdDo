...
func (m *MockUseCase) FullSearch(text string) (artist.SearchResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FullSearch", text)
	ret0, _ := ret[0].(artist.SearchResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// FullSearch indicates an expected call of FullSearch.
func (mr *MockUseCaseMockRecorder) FullSearch(text interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FullSearch", reflect.TypeOf((*MockUseCase)(nil).FullSearch), text)
}
...
func (m *MockUseCase) GetUserArtists(userId string) (artist.LikedArtists, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUserArtists", userId)
	ret0, _ := ret[0].(artist.LikedArtists)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetUserArtists indicates an expected call of GetUserArtists.
func (mr *MockUseCaseMockRecorder) GetUserArtists(userId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserArtists", reflect.TypeOf((*MockUseCase)(nil).GetUserArtists), userId)
}
...
func (m *MockRepository) GetByUserId(userId string) ([]artist.Base, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Search(text string) ([]artist.Base, error) {
	m.ctrl.T.Helper()
