...
func (m *MockUsecase) Expire(userId uint64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Expire", userId)
	ret0, _ := ret[0].(error)
	return ret0
}

// Expire indicates an expected call of Expire.
func (mr *MockUsecaseMockRecorder) Expire(userId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Expire", reflect.TypeOf((*MockUsecase)(nil).Expire), userId)
}
